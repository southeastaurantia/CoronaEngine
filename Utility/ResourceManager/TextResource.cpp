#include "include/TextResource.h"
#include <Log.h>
#include <algorithm>
#include <fstream>
namespace Corona {
    ...
    bool TextResourceLoader::supports(const ResourceId &id) const { for(const auto &e: exts_) if(endsWith(id.path,e)) return true; return false; }
