...
set(CORONA_EMBEDDED_PY_DIR "${CMAKE_SOURCE_DIR}/Env/Python-3.13.7" CACHE PATH "嵌入式(内置) Python 目录路径")
    ...
    if(NOT Python3_FOUND)
        if(CORONA_PYTHON_USE_EMBEDDED_FALLBACK)
            ...
            if(EXISTS "${_CORONA_EMBEDDED_EXE}")
                ...
                message(FATAL_ERROR "[Python] 未找到系统 Python(>=${CORONA_PYTHON_MIN_VERSION})，且嵌入式解释器缺失: ${_CORONA_EMBEDDED_EXE}")
            endif()
        else()
