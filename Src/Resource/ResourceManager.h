...
//                 if (!res_loader)
//                 {
//                     LOG_ERROR("Resource type '{}' load failed: Not register resource loader", typeid(ResourceType).name());
//                     promise->set_exception(std::make_exception_ptr(std::runtime_error(fmt::format("Resource type '{}' load failed: Not register resource loader", typeid(ResourceType).name()))));
//                     return future;
//                 }
//
